...
// JK: Added to support 64-bit architecture
#ifdef PPC64
...
// JK: Apply pre-processor token pasting to the expansions of x and y.
...
// concantenation is performed. Note: One auxilliary level ought to be
// sufficient, but two are used because of bugs in some preprocessors.
#define PASTE_TOKENS(x, y) PASTE_TOKEN_AUX(x, y)
#define PASTE_TOKEN_AUX(x, y) PASTE_TOKEN_AUX2(x, y)
#define PASTE_TOKEN_AUX2(x, y) x ## y

// JK: Helper macros for construction file names for includes
