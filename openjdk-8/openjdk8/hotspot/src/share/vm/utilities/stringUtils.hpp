...
class StringUtils : AllStatic {
    public:
        // Replace the substring <from> with another string <to>. <to>
        // must be no longer than <from>. The input string is modified
        // in-place.
        //
        // Replacement is done in a single pass left-to-right. So
        // replace_no_expand("aaa", "aa", "a") will result in "aa",
        // not "a".
        //
