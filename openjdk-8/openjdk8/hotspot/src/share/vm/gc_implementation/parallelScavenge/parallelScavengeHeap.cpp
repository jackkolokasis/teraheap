...
jint ParallelScavengeHeap::initialize() {
  ...
  const size_t heap_size = _collector_policy->heap_reserved_size_bytes();
  ...
  // Create here the adjoining generations for the Parallel Scavenge
  // heap. Create_adjoining_generations based on the heap type
  // Heterogeneous Heap
  //    - DRAM: New Generation
  //    - Storage Device: Old generation
  // Simple Heap
  //    - DRAM: New + Old Generation
