...
// ==============================================
//
// JK: Create and assign Java Heap
...
jint Universe::initialize_heap() {
  ...
  if (UseParallelGC) {
    ...
    // JK: At this point there is no real allocation space, just
    // initialize some parameters, the real allocation space is in
