...
#
# To Run: ./pgen_resume.sh 100 10 gen_data/
#
...
while [ $i -le $NUMBER_OF_FILES ]; do
    /mnt/raid/BigDataGeneratorSuite/Table_datagen/personal_generator/pgen_personal_resume $NUM_RESUME $i > "$DATA_DIR/Resume_${i}"&   
