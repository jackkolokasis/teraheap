...
//*************Init*************
    //
    //
    ifstream if_firstname("./dict/names.dict");
    ifstream if_familyname("./dict/family_names.dict");
    ifstream if_address("./dict/depart_address.dict");
    ifstream if_hometown("./dict/hometown.dict");
    ifstream if_interest("./dict/interest.dict");
    ifstream if_tittle("./dict/tittle.dict");
    ifstream if_institute("./dict/institute.dict");
    ifstream if_school("./dict/school.dict");
    ifstream if_papers_source("./dict/papers_source.dict");
    ifstream if_publication("./dict/publication.dict");
