...
for((i=0;i<${NUM_TRIALS};i++)); do		
	...
	purge_data "${MC_LIST}"	
	OPTION=" ${INOUT_SCHEME}${INPUT_HDFS} ${INOUT_SCHEME}${OUTPUT_HDFS_Classification} ${NUM_OF_CLASS_C} ${impurityC} ${maxDepthC} ${maxBinsC} ${modeC} ${STORAGE_LEVEL} ${NUM_OF_PARTITIONS}"
