...
MEM_PER_EXECUTOR=400
EXECUTORS=1
LOG_START="start.txt"
LOG_END="stop.txt"
LOG_DSTAT_START="dstat_start.txt"
LOG_DSTAT_END="dstat_end.txt"

#BENCHMARKS=( "KMeans" "LinearRegression" "LogisticRegression" "SVM")
...
do
    ...
    do
        ...
        do
            ...
            getCPU ${LOG_START} ${LOG_DSTAT_START}
            ...
            # Get current CPU utilization
            getCPU ${LOG_END} $LOG_DSTAT_END

            # Calculate cpu utilization
            ./cpuUtil.sh ${LOG_START} ${LOG_END} > ${RUN_DIR}/cpuUtil.txt
            mv ${LOG_START} ${RUN_DIR}/
            mv ${LOG_END} ${RUN_DIR}/
            mv ${LOG_DSTAT_START} ${RUN_DIR}/
            mv ${LOG_DSTAT_END} ${RUN_DIR}/
