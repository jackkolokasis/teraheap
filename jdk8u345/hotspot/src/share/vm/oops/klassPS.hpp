...
#define PARALLEL_GC_DECLS \
  ...
  virtual void h2_oop_push_contents(PSPromotionManager* pm, oop obj);       \
  virtual void h2_oop_trace_contents(PSPromotionManager* pm, oop obj);      \
...
#define PARALLEL_GC_DECLS_PV \
  ...
  virtual void h2_oop_push_contents(PSPromotionManager* pm, oop obj) = 0;   \
  virtual void h2_oop_trace_contents(PSPromotionManager* pm, oop obj) = 0;  \
