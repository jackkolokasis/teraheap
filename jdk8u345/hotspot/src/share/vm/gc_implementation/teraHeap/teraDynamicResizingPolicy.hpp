...
private:
  ...
  static double last_full_gc_ms;          //< Track when the last gc
                                          //has been performed
...
public:
  ...
  static void gc_end(double gctime, double last_full_gc);
  ...
  static void debug_print(double iowait_time_ms,
                          uint64_t device_active_time_ms, double interval);
};
