...
void ObjectStartArray::th_initialize(MemRegion reserved_region) {
  ...
  assert((int)th_block_size == (int)CardTableModRefBS::th_card_size, "Sanity");
  assert((int)th_block_size <= (int)CardTableModRefBS::th_card_size,
		  err_msg("block_size must be less than or equal to %d", (1 << CardTableModRefBS::th_card_shift)));
