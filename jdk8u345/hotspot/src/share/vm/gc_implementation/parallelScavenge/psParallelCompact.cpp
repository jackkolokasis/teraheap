...
bool PSParallelCompact::absorb_live_data_from_eden(PSAdaptiveSizePolicy* size_policy,
  ...
  // We also return false when it's a heterogenous heap because old
  // generation cannot absorb data from eden when it is allocated on
  // different memory (example, nv-dimm) than young.
